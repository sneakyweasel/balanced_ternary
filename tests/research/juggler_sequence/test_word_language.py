...
def test_existential_witnesses_and_short_language():
    ...
    assert follows_word(EXAMPLES["eeoe_start"], EXAMPLES["eeoe"])
...
def test_prefix_futures_are_coarser_than_landings():
    report = word_language_census(n_max=400, r_max=4, l_r_max=3, l_n_max=50)
...
def test_lean_api_and_sorry_free():
    ...
    assert "import Problems.Juggler.WordLanguage" in text
