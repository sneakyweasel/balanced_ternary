...
- **Cycles:** no nontrivial cycle of period \(<478245\) at the
 ...
 Thm 5.3, and the defect-to-hug-charge chain (§5.2 + Thm 5.4
 analytic half) are Lean (`WalkChargeWords.lean`,
 `OstrowskiSandwich.lean`, `OstrowskiNumeration.lean`,
 `WalkTransport.lean`, `WalkChargeMax.lean`); of the §5 envelope
 chain only the rotation average, Denjoy–Koksma, and the kill
