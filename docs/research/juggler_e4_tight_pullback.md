...
Status: **E4_TIGHT_PULLBACK_REFUTED**
...
- EEEE word: `OOOOOOOEEEE`
- ideal threshold: `n^{139} > 2^{4118}`
- ideal N0: `828484394`
- all 30 miss n<=800: `True`

OOOOOOOEEEE already uses the sharp r=4 trailing-evens cell z<(n+1)^{16}; even Z=n^{16} is n^{139}>2^{4118} and first fires at n=828484394; all 30 length-11 words miss n<=800; not a length-11 census.
