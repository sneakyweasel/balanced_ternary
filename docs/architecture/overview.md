...
| Experimental dynamics | `research_engine` | integer affine/block/trajectory, R/K/L, algebra, attacks, planner, synthetic benchmarks, and theorem targets (not proofs); `btprime research` is the CLI wrapper; R10 |
