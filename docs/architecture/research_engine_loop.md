...
Phase-12 (`research_engine.control.juggler_parity_drift`) tests whether
fixed parity words have exact log-log energy surrogates.
...
[juggler_parity_drift_phase12.md](../research/juggler_parity_drift_phase12.md).
