...
v2.3 Phases 1–4 (hypotheses, inductive/ranking certificates, law/domain
split, quantifier probes; no new flood attacks; involution census still
unimplemented; overlapping-domain census still unimplemented) is
