# Juggler empty-odd-cell geometry of PE landings
...
Stop criterion          no forward consequence; density only;
                        word census; PredClosure rename
```
...
- Probe: `research.juggler_sequence.empty_odd_cell`
- Records: [juggler_empty_odd_cell.md](../research/juggler_empty_odd_cell.md),
  [juggler_empty_odd_cell.json](../research/juggler_empty_odd_cell.json)
- Tests: `tests/research/juggler_sequence/test_empty_odd_cell.py`
...
proof. `odd_cell_unique` and `odd_cell_iff` stay in `Cells.lean`.
...
has no forward dynamical consequence beyond `odd_cell_unique` and
