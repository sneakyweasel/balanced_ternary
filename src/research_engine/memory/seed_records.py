...
def historical_experiments() -> tuple[MemoryExperiment, ...]:
    ...
    juggler_exp = MemoryExperiment(
        ...
        diagnosis=_diag(
            ...
            juggler_fp,
            ResearchDecision.CONTINUE,
            "finite seed-13 closure with no piecewise-affine cover; not a halt theorem",
            prior="KNOWN",
            lean="Problems.Engine.FloorPower",
            exact="floorPower_thirteen_reaches_one",
            falsification="odd 3 grows; T(8)=2 is not the 5x/4 strip; seed-13 halt is not a Z-theorem",
            machinery="",
        ),
        decision_reason_code=DecisionReason.DISTINCT_REGIME,
        representation_novelty=NoveltyLevel.MEDIUM,
        ...
        failures=(
            _fail(
                ...
                "NON_AFFINE",
                "outside_affine_valuation_control",
                "even/odd floor powers have no complete piecewise-affine cover on the sample window",
                "Floor-power successors are outside residue-affine language; a finite seed-13 closure is not the aliquot fingerprint and not a Z-theorem.",
                "latent_affine",
                attack="piecewise_affine",
                value=ImportanceLevel.HIGH,
                prior="KNOWN",
                example="odd n |-> floor(n**(3/2))",
            ),
        ),
        grey_loot=(
            GreyLoot(
        ...
        run_artifact=RunArtifact(
            attack_statuses={"piecewise_affine": "INCONCLUSIVE", "closure": "SUPPORTED"},
            lean_theorems=("Problems.Engine.FloorPower",),
            strongest_exact="floorPower_thirteen_reaches_one",
            strongest_falsification="odd 3 grows; seed-13 halt is not a Z-theorem",
    ...
    reverse_exp = MemoryExperiment(
        ...
        diagnosis=_diag(
            ...
            reverse_fp,
            ResearchDecision.CONTINUE,
            "finite seed-196 closure with no piecewise-affine cover; not a reverse-fixed theorem",
            prior="KNOWN",
            lean="Problems.Engine.ReverseAdd",
            exact="reverseAdd_one_ninety_six_reaches_zero",
            falsification="T(196)=392 is not digit-sum or aliquot; T(8)=0 is not floor-power; seed-196 halt is not a Z-theorem",
            machinery="",
        ),
        decision_reason_code=DecisionReason.DISTINCT_REGIME,
        representation_novelty=NoveltyLevel.MEDIUM,
        ...
        failures=(
            _fail(
                ...
                "NON_AFFINE",
                "outside_affine_valuation_control",
                "digit reverse-plus-add has no complete piecewise-affine cover on the sample window",
                "Digit reverse-plus-add is outside residue-affine language; a finite seed-196 closure is not digit-fold, not aliquot, and not a Z-theorem.",
                "latent_affine",
                attack="piecewise_affine",
                value=ImportanceLevel.HIGH,
                prior="KNOWN",
                example="n |-> n + digit_reverse(n)",
            ),
        ),
        grey_loot=(
            GreyLoot(
        ...
        run_artifact=RunArtifact(
            attack_statuses={"piecewise_affine": "INCONCLUSIVE", "closure": "SUPPORTED"},
            lean_theorems=("Problems.Engine.ReverseAdd",),
            strongest_exact="reverseAdd_one_ninety_six_reaches_zero",
            strongest_falsification="T(196)=392 is not digit-sum or aliquot; seed-196 halt is not a Z-theorem",
            census_kind="UNRESOLVED",
        ),
        finalized=True,
    )
    ...
    home_exp = MemoryExperiment(
        ...
        diagnosis=_diag(
            ...
            home_fp,
            ResearchDecision.CONTINUE,
            "truncated seed-49 prefix with no piecewise-affine cover; not a prime-reachability theorem",
            prior="KNOWN",
            lean="Problems.Engine.FactorConcat",
            exact="four_reaches_two_eleven",
            falsification="T(49)=77 is not aliquot or floor-power; T(8)=222 is not reverse-add; seed-49 prefix is not a Z-theorem",
            machinery="",
        ),
        decision_reason_code=DecisionReason.DISTINCT_REGIME,
        representation_novelty=NoveltyLevel.MEDIUM,
        ...
        failures=(
            _fail(
                ...
                "NON_AFFINE",
                "outside_affine_valuation_control",
                "factor concatenation has no complete piecewise-affine cover on the sample window",
                "Factor concatenation is outside residue-affine language; a budget-truncated seed-49 prefix is not aliquot truncation and not a prime-reachability theorem.",
                "latent_affine",
                attack="piecewise_affine",
                value=ImportanceLevel.HIGH,
                prior="KNOWN",
                example="n |-> concat(prime factors of n)",
            ),
        ),
        grey_loot=(
            GreyLoot(
        ...
        run_artifact=RunArtifact(
            attack_statuses={"piecewise_affine": "INCONCLUSIVE", "closure": "SUPPORTED"},
            lean_theorems=("Problems.Engine.FactorConcat",),
            strongest_exact="four_reaches_two_eleven",
            strongest_falsification="T(49)=77 is not aliquot or floor-power; seed-49 prefix is not a Z-theorem",
            census_kind="UNRESOLVED",
        ),
        finalized=True,
    )
...
def _lesson_fields() -> dict[str, dict]:
    return {
        ...
        "juggler:loot:mismatch": dict(
            observation="piecewise-affine census is INCONCLUSIVE; affine_system is None",
            reusable_lesson="even/odd floor powers are outside residue-affine language; do not add a radical attack",
            possible_transfer_targets=(),
            status=GreyLootStatus.REUSED,
            engineering_action="REUSED",
            prior_art_status="KNOWN",
        ),
        "juggler:loot:seed13": dict(
            observation="13 -> 46 -> 6 -> 2 -> 1 in four steps; T(1)=1",
            reusable_lesson="a finite seed closure is not a halt theorem on all positive integers",
            possible_transfer_targets=(),
            status=GreyLootStatus.REUSED,
            engineering_action="REUSED",
            prior_art_status="KNOWN",
            counterexample="13 reaches 1; odd 3 grows",
        ),
        "juggler:loot:cluster": dict(
            observation="seed-13 fingerprint is FINITE_SEED_CLOSURE, unlike aliquot factorization truncation",
            reusable_lesson="a nonlinear integer map can close on a packet seed and still sit outside affine control",
            possible_transfer_targets=(),
            status=GreyLootStatus.REUSED,
            engineering_action="REUSED",
            prior_art_status="KNOWN",
        ),
        "reverse_add_bt:loot:mismatch": dict(
            observation="piecewise-affine census is INCONCLUSIVE; affine_system is None",
            reusable_lesson="digit reverse-plus-add is outside residue-affine language; do not add a reverse-add attack",
            possible_transfer_targets=(),
            status=GreyLootStatus.REUSED,
            engineering_action="REUSED",
            prior_art_status="KNOWN",
        ),
        "reverse_add_bt:loot:seed196": dict(
            observation="196 -> 392 -> ... -> 0 in eight steps; T(0)=0; W(196)=196",
            reusable_lesson="a finite seed closure is not a reverse-fixed theorem on all integers",
            possible_transfer_targets=(),
            status=GreyLootStatus.REUSED,
            engineering_action="REUSED",
            prior_art_status="KNOWN",
            counterexample="196 reaches 0; W(2)=-2",
        ),
        "reverse_add_bt:loot:cluster": dict(
            observation="seed-196 fingerprint is FINITE_SEED_CLOSURE, unlike digit-fold, aliquot truncation, and floor-power closure",
            reusable_lesson="digit reverse-plus-add can close on a packet seed and still sit outside affine control and outside digit-fold saturation",
            possible_transfer_targets=(),
            status=GreyLootStatus.REUSED,
            engineering_action="REUSED",
            prior_art_status="KNOWN",
        ),
        "home_prime:loot:mismatch": dict(
            observation="piecewise-affine census is INCONCLUSIVE; affine_system is None",
            reusable_lesson="factor concatenation is outside residue-affine language; do not add a concatenation attack",
            possible_transfer_targets=(),
            status=GreyLootStatus.SATURATED,
            engineering_action="CLOSE",
            prior_art_status="KNOWN",
        ),
        "home_prime:loot:seed49": dict(
            observation="49 -> 77 -> ... then truncates at the factorization cap; T(7)=7",
            reusable_lesson="a budget-truncated prefix is not a theorem that seed 49 reaches a prime",
            possible_transfer_targets=(),
            status=GreyLootStatus.SATURATED,
            engineering_action="CLOSE",
            prior_art_status="KNOWN",
            counterexample="49 maps to 77; 4 reaches 211",
        ),
