...
def _specs() -> tuple[ExperimentSpec, ...]:
    ...
    return (
        ExperimentSpec(
            ...
            "Existing runner; prefer btprime collatz experiment",
        ),
        ExperimentSpec(
            "collatz.information",
            ...
            "Existing runner; prefer btprime collatz information-test",
        ),
        ExperimentSpec(
            ...
            "collatz",
            run_near_critical,
            "Existing runner; prefer btprime collatz near-critical",
        ),
        ExperimentSpec(
            ...
            "Existing runner; prefer btprime collatz affine-center-census",
        ),
        ExperimentSpec(
            ...
            "Existing runner; prefer btprime collatz fixed-integer-census",
        ),
        ExperimentSpec(
            "collatz.warp",
            ...
            "collatz",
            run_bt_warp_census,
            "Existing runner; prefer btprime collatz warp-census",
        ),
        ExperimentSpec(
            "collatz.cycles",
            ...
            "collatz",
            run_cycle_census,
            "Existing runner; prefer btprime collatz cycle-census",
        ),
        ExperimentSpec(
            "collatz.complexity",
            ...
            "Existing runner; prefer btprime collatz complexity",
        ),
        ExperimentSpec(
            "collatz.suffix",
            ...
            "Existing runner; prefer btprime collatz suffix-test",
        ),
    )
