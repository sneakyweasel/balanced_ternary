...
def classify_pair(a: str, b: str, *, limit: int = 400) -> InteractionRecord:
    ...
    known: dict[tuple[str, str], InteractionRecord] = {
        ("N", "N"): InteractionRecord(
            "N", "N", CommutationClass.EXACT, "N∘N = id", "PROVED", None, "0", 0,
            "Involution.",
        ),
        ("S", "N"): InteractionRecord(
            "S", "N", CommutationClass.EXACT, "S∘N = N∘S = -3n", "PROVED", None, "0", 0,
            "Both are Z-linear.",
        ),
        ("N", "S"): InteractionRecord(
            "N", "S", CommutationClass.EXACT, "N∘S = S∘N", "PROVED", None, "0", 0,
            "Both are Z-linear.",
        ),
        ("D", "N"): InteractionRecord(
            "D", "N", CommutationClass.EXACT, "D∘N = N∘D", "PROVED", None, "0", 0,
            "a0(-n) = -a0(n), so the quotient commutes with sign.",
        ),
        ("N", "D"): InteractionRecord(
            "N", "D", CommutationClass.EXACT, "N∘D = D∘N", "PROVED", None, "0", 0,
            "Digitwise negation commutes with dropping the LSD.",
        ),
        ("D", "S"): InteractionRecord(
            "D", "S", CommutationClass.CONJUGACY, "D∘S = id, S∘D(n) = n - a0(n)",
            "PROVED", None, "a0(n) in {-1,0,1}", 1,
        ...
        ("S", "M2"): InteractionRecord(
            "S", "M2", CommutationClass.EXACT, "S∘M2 = M2∘S = 6n", "PROVED", None, "0", 0,
            "Multiplication operators commute.",
        ),
        ("M2", "S"): InteractionRecord(
            "M2", "S", CommutationClass.EXACT, "M2∘S = S∘M2", "PROVED", None, "0", 0,
            "Multiplication operators commute.",
        ),
        ("M2", "N"): InteractionRecord(
            "M2", "N", CommutationClass.EXACT, "M2∘N = N∘M2", "PROVED", None, "0", 0,
            "Z-linear.",
        ),
        ("N", "M2"): InteractionRecord(
            "N", "M2", CommutationClass.EXACT, "N∘M2 = M2∘N", "PROVED", None, "0", 0,
            "Z-linear.",
        ),
        ("Wz", "S"): InteractionRecord(
            "Wz", "S", CommutationClass.EXACT, "Wz∘S = S∘Wz", "PROVED", None, "0", 0,
            "Wz(3n)=3 Wz(n) because trailing zeros are kept.",
        ),
        ("S", "Wz"): InteractionRecord(
            "S", "Wz", CommutationClass.EXACT, "S∘Wz = Wz∘S", "PROVED", None, "0", 0,
            "Companion of Wz∘S = S∘Wz.",
        ),
        ("W", "Wz"): InteractionRecord(
            "W", "Wz", CommutationClass.SUBSET, "W = Wz on {n : 3 does not divide n} ∪ {0}",
            "PROVED", "3-free integers", None, 0,
            "Wz(n)=W(n) 3^{v3(n)}.",
        ),
        ...
        ("W", "Wt"): InteractionRecord(
            ...
            "VERIFIED COMPUTATIONALLY", None, None, None,
        ...
        ("W", "H2"): InteractionRecord(
            ...
            "VERIFIED COMPUTATIONALLY", "even n with W(n) even", None, None,
        ...
        ("H2", "M2"): InteractionRecord(
            "H2", "M2", CommutationClass.EXACT, "H2∘M2 = id", "PROVED", None, "0", 0,
            "On all of Z, because M2 lands in 2Z.",
        ),
        ("M2", "H2"): InteractionRecord(
            "M2", "H2", CommutationClass.EXACT, "M2∘H2 = id on 2Z", "PROVED", "2Z", "0", 0,
            "Partial identity.",
        ),
        ("K3", "W"): InteractionRecord(
            "K3", "W", CommutationClass.EXACT, "K3∘W = W∘K3 = W", "PROVED", None, "0", 0,
            "W(n) is 3-free for every n.",
        ),
        ("W", "K3"): InteractionRecord(
            "W", "K3", CommutationClass.EXACT, "W∘K3 = K3∘W = W", "PROVED", None, "0", 0,
            "Companion.",
        ),
        ("K3", "N"): InteractionRecord(
            "K3", "N", CommutationClass.EXACT, "K3∘N = N∘K3", "PROVED", None, "0", 0,
            "v3(-n)=v3(n).",
        ),
        ("N", "K3"): InteractionRecord(
            "N", "K3", CommutationClass.EXACT, "N∘K3 = K3∘N", "PROVED", None, "0", 0,
            "Companion.",
        ),
        ("K3", "S"): InteractionRecord(
            "K3", "S", CommutationClass.EXACT, "K3∘S = K3", "PROVED", None, None, 0,
