...
Those start OO and end E. The even-terminating expanding words
...
def lean_api_present() -> dict[str, bool]:
    ...
    return {
        ...
        **named,
        **forbidden,
        "laboratory_assembler_present": "theorem no_cycle_word_even_count_le_three"
        in even_text,
...
def classify(scan: dict[str, Any], lean: dict[str, bool]) -> dict[str, Any]:
    ...
    return {
        ...
        "reason": (
            ...
            "Lean excludes every CycleWord with even-count <= 3, "
...
def probe_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "decision": decision,
        "search_method": (
            "even-terminating expanding words with e<=3 at lengths "
