...
from research.collatz.automata.valuation_shift import GrowthBudget, follow_path, growth_budget
from research.collatz.cylinders import precision_cost, valuation_cylinder
...
def edge_agrees_with_follow_path(edge: SymbolicEdge, leftover_q: int) -> bool:
    ...
    from research.collatz.automata.valuation_shift import PrecisionState
