...
PROBLEM = ProblemDefinition(
    ...
    statement=(
        ...
        "the bounded ray. Complete-word val(UV)=val(V)-E_|V|(c_U) "
        "(Lean val_concat_energy, KNOWN); complete zero-value words "
        "are not a monoid (witness (1,-2)(1,-2)). Live complete "
